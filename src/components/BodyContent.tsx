...
function BodyContent() {
  ...
  <Group position='center'>
    <Image
      ...
      <Grid.Col>
      <Text style={{ inlineSize: '350px', overflowWrap: 'break-word' }}>Welcome to the official website for the University of Florida's Rock Climbing Club! Here you will find all club communication, events, and announcements. If you have any questions, feel free to contact us at ufrockclimbing@gmail.com!</Text>
      </Grid.Col>
      </Grid>
  </Group>
  </>);
